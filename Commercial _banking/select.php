...
<html lang="en">
 <head>
    ...
    <title>Prem's Bank | Transfer Money</title>
 ...
 <body>
    <div class="containe">
        ...
        <div class="navigatio">
            <div class="logo">
                ...
                Prem's<span class="logo-hlt"></span> Bank
            </div>
            <nav>
                <ul>
                    <li>
    ...
    <!----------Footer---------->
    <footer id="footer">
        <p>&copy; Copyright 2021 <span class="footer_logo">Prem's Bank</span></p>
        <div class="social-icon">
                <a href="https://http://www.linkedin.com/in/bardaval-premsingh-b38110198"><i class="fab fa-linkedin-in"></i></a>
                <a href="mailto: bardavalpremsingh6789@gmail.com"><i class="fas fa-envelope"></i></i></a>
